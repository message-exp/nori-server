...
from proto_generated.nori.v0.room.room_service_pb2_grpc import RoomServiceServicer, add_RoomServiceServicer_to_server
...
class RoomServicer(RoomServiceServicer):
    ...
    def UpdateRoomBasic(self, request: RoomBasicInfoRequest, context: ServicerContext) -> Empty:
