...
def mock_repositories(
    ...
    mocker.patch("src.api.user.user_network_service.get_db", return_value=mock_db_session)
    mock_user_repo: MagicMock = mocker.patch("src.api.user.user_network_service.UserRepo")
    mock_room_repo: MagicMock = mocker.patch("src.api.user.user_network_service.RoomRepo")
    mock_room_member_repo: MagicMock = mocker.patch("src.api.user.user_network_service.RoomMemberRepo")
    mock_refresh_token_repo: MagicMock = mocker.patch("src.api.user.user_network_service.RefreshTokenRepo")
