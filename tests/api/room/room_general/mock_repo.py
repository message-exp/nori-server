...
def mock_repositories(
    ...
    mock_user_repo: MagicMock = mocker.patch("src.api.room.room_general_service.UserRepo")
    mock_room_repo: MagicMock = mocker.patch("src.api.room.room_general_service.RoomRepo")
    mock_room_member_repo: MagicMock = mocker.patch("src.api.room.room_general_service.RoomMemberRepo")
