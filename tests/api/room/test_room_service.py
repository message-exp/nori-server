...
def mock_repositories(
    ...
    mock_user_repo: MagicMock = mocker.patch("src.api.room.room_service.UserRepository")
    mock_room_repo: MagicMock = mocker.patch("src.api.room.room_service.RoomRepository")
