...
# @pytest.fixture
# def test_get_message_success(mock_repositories: Tuple[MagicMock, MagicMock, MagicMock, MagicMock], grpc_context: MagicMock) -> None:
#     mock_message_repo, mock_user_repo, mock_room_member_repository  ,mock_room_repository= mock_repositories
#     mock_message_repo.return_value.get_message_by_roomId.return_value = [
#         MagicMock(room_id=123, text="abc"),
#         MagicMock(room_id=123, text="def"),
#         MagicMock(room_id=123, text="ghi")
...
def test_send_message_success(
    ...
    mock_message_repo.return_value.add_message_to_db.return_value = MagicMock( id = 1 ,room_id=123, text="abc") #Message
    ...
    mock_message_repo.return_value.add_message_to_db.assert_called_once_with(Messages(room_id = 123,message="abc"))
